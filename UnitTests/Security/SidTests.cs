...
namespace UnitTests.Security
{
    public class SidTests
    {
        ...
        {
            // Arrange
            var expected = new byte[] { 0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05,
                0x15, 0x00, 0x00, 0x00, 0x2E, 0x43, 0xAC , 0x40, 0xC0, 0x85, 0x38,
                0x5D, 0x07, 0xE5, 0x3B, 0x2B };
        ...
        public void ToHex_Should_ReturnExpectedResult_When_ByteProvided()
        {
            ...
            var sid = new byte[] { 0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05,
                0x15, 0x00, 0x00, 0x00, 0x2E, 0x43, 0xAC , 0x40, 0xC0, 0x85, 0x38,
                0x5D, 0x07, 0xE5, 0x3B, 0x2B };
