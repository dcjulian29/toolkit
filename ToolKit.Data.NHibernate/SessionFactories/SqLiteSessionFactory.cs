...
{
    /// <summary>
    /// NHibernate Session Factory using SQLite
    /// </summary>
    public class SqLiteSessionFactory : SessionFactoryBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqLiteSessionFactory"/> class.
        /// </summary>
        /// <param name="connectionString">The connection string to use.</param>
        public SqLiteSessionFactory(string connectionString)
        ...
        public SqLiteSessionFactory(string connectionString, bool createDatabase)
